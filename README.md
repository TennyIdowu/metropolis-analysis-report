...
### Dashboard Preview
![dashboard](Metropolis_Dashboard.png)
...
- Public Safety Initiatives: Launch targeted awareness campaigns focusing on the primary collision types (e.g., rear-end or angle crashes) identified as the most frequent causes of injury.
 ...
 ## Links
 [Interactive Power BI Dashboard](https://app.powerbi.com/view?r=eyJrIjoiN2NmNzVlOGQtYTAxMy00ZjExLTk2N2EtZDEwMTg4YWY1OGYxIiwidCI6IjllMDVmZmZjLTRiODctNGE3NS1hZDU3LWIyYjE4OWNiOTlhYiJ9)
